...
?>
  <from id="info" method="POST">
    <div class="main-body" style="min-height: calc(100vh - 300px); color:black; max-width:80%; margin:auto; margin-top:5%">
      <div class="real-body">
          ...
          <table id="examtable" class="display">
            <thead>
              <tr style="background-color: #b52A2A;">
                ...
                <th style="font-size:30px;">date_exam</th>
